<?php
  ...
  //end of location based search
    ...
    try {
        $stmt = $connect->prepare("SELECT * FROM restaurant WHERE name IN $concats OR name IN $loc OR city IN $concats OR city IN $loc OR state IN $concats OR state IN $loc OR address IN $concats OR address");
        $stmt->execute();
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Search Restaurant</h2>
            <h3 class="section-subheading text-muted">See all the available listig of restaurant</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            ...
            <?php
                ...
                if(count($data) !== 0){
                  echo "<h2 class='text-center'>List of restaurant Details</h2>";
                }else{
