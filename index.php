...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <!-- Header -->
    <header class="masthead" style="background-image: url('./imgs/bg.png'); background-position-y: 20px;">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To Business Directory</div>
          <div class="intro-heading text-uppercase">Search Best Restaurant and Hotel<br></div>
        </div>
      </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading text-uppercase">Search For</h2>
                    <h3 class="section-subheading text-muted">Search from more than 1000+ hotels and restaurants</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="card" style="width: 28rem;">
                        <img class="card-img-top" src="./imgs/hotelsearch.jpg" alt="Card image cap" height="400px" width="100%">
                        <div class="card-body">
                            <a href="search_hotels.php" class="btn btn-info">search Hotels</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card" style="width: 28rem;">
                        <img class="card-img-top" src="./imgs/restaurnantsearch.jpg" alt="Card image cap" height="400px" width="100%">
                        <div class="card-body">
                            <a href="search_restaurant.php" class="btn btn-info">search Restaurant</a>
                        </div>
                    </div>
                </div>
            </div>
