...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO restaurant(name, phone, email, address, city, state, website, description, rating, pincode) VALUES(:name, :phone, :email, :address, :city, :state, :website, :description, :rating, :pincode)";
  ...
  if ($Execute) {
    echo '<script>window.open("./restaurant.php?message=Record has been added successfully","_self")</script>';
  } else {
