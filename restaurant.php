<?php
        ...
        $stmt = $connect->prepare("SELECT * FROM restaurant");
        $stmt->execute();
...
<html lang="en">
  <head>
    ...
    <title>restaurant :: Business Directory Listing</title>
      ...
      <div class="container">
        <div class="row">
          ...
          <?php if($message != ''){
            ...
            <h2 class="section-heading text-uppercase">restaurant List</h2>
